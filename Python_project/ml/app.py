...
@app.route('/')
def index():
    return render_template('index.html') #html 출력

# 선형회귀 페이지
@app.route('/score/page1')
def score_page1():
    return render_template('page1.html') #html 출력
...
def score_page2():
    return render_template('page2.html') #html 출력
...
def score_page3():
    return render_template('page3.html') #html 출력
