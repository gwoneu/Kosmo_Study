...
const ReviewPage = ({location, setBook, book}) => {
    ...
    return (
        <div className='reviewpage_content py-3'>
            {!sessionStorage.getItem("uid") ? 
                ...
                <div>
                    ...
                    <div className='text-end mt-2'>
                        <Button className='px-5' variant='dark' onClick={onClickRegister}>등록</Button>
                    </div>    
                </div>    
            }
            {reviwes.map(review=>
                                ...
                                {sessionStorage.getItem("uid") === review.uid &&    
                                    <div className='text-end'>
                                        <Button onClick={()=>onClickDelete(review.rid)}
                                            variant='outline-dark' size='sm me-2'>삭제</Button>
                                        <Button onClick={()=>onClickUpdate(review.rid)}
                                            size='sm' variant='dark'>수정</Button>
                                    </div>    
                                }
                            </>
                            :
                            <>
                                ...
                                <div className='text-end mt-2'>
                                    <Button onClick={()=>onClickSave(review.rid, review.text, review.contents)} 
                                        variant='dark' size="sm me-2">저장</Button>
