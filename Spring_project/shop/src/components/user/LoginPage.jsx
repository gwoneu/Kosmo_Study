                ...
                <Col md={6}>
                    <Card className='p-3 mx-5'>
                        <form onSubmit={onSubmit}>
                            <Form.Control name='uid' value={uid} className='mb-3' placeholder='아이디' onChange={onChange} />
                            <Form.Control name='upass' value={upass} className='mb-3' placeholder='비밀번호' type='password' onChange={onChange} />
